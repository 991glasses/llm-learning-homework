...
class PDFTranslator:
    def __init__(self, model_name: str, glm_endpoint: str):
        self.translate_chain = TranslationChain(model_name, glm_endpoint)
        ...
        for page_idx, page in enumerate(self.book.pages):
            for content_idx, content in enumerate(page.contents):
                ...
                translation, status = self.translate_chain.run(
                    content, source_language, target_language, style, model
                )
